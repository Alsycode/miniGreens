...
export const subscriptionPlans: SubscriptionPlan[] = [
  ...
  { id: "sub-6", name: "Workplace Wellness Box", description: "Keep your team thriving with fresh microgreens weekly", price: 699, unit: "week", deliveryFrequency: "Weekly", items: ["5 assorted microgreens", "2 wellness shots", "Team recipes"], benefits: ["Free delivery", "Priority support", "Bulk ordering", "Cancel anytime"], isPopular: true, color: "#42A5F5" },
];
